  ...
  return (
    <div className="relative flex h-full flex-col items-center justify-center">
      <ul className="grid grid-cols-2 gap-4">
        {!readyToRemove &&
          imagesToShow.map((image) => {
            ...
            return (
              <li key={image} className="relative flex h-25 w-25">
                <div
                  className={clsx(
      ...
      {imagesToRemove.length > 0 && !readyToRemove ? (
        <div className="absolute bottom-4 flex gap-1 rounded-xl p-1 shadow-[0_0_0_1px_rgba(0,0,0,0.08),0px_8px_8px_-8px_rgba(0,0,0,0.16)] will-change-transform">
          <div className="flex w-full justify-between gap-2">
            <button className="flex w-12 flex-col items-center gap-px rounded-lg bg-[#F9F9F8] pt-2 pb-1 text-[10px] font-medium text-[#8D8D86]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <button
              ...
              className="flex w-12 flex-col items-center gap-px rounded-lg bg-[#F9F9F8] pt-2 pb-1 text-[10px] font-medium text-[#8D8D86] hover:bg-[#FFF7F7] hover:text-[#E5484D]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
      ...
      {readyToRemove ? (
        <div className="absolute top-1/2 z-10 h-24 w-24 -translate-y-1/2">
          <div>
            <TrashBack />
          </div>

          <div className="absolute top-5 flex w-full flex-col-reverse items-center">
          ...
          <div className="absolute bottom-0 left-1/2 h-full w-23.5 -translate-x-1/2">
            <TrashFront />
          </div>
        </div>
      ) : null}
